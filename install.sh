...
echo "  node(latest): A JavaScript runtime built on Chrome's V8 JavaScript engine"

brew install node@16 > /dev/null 2>&1
echo "  node v16: A JavaScript runtime built on Chrome's V8 JavaScript engine"

brew install node@10 > /dev/null 2>&1
echo "  node v10: A JavaScript runtime built on Chrome's V8 JavaScript engine"
