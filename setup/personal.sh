...
gum spin --title "skhd: Simple hotkey-daemon for macOS" -- brew install koekeishiya/formulae/skhd
gum spin --title "skhd: Simple hotkey-daemon for macOS" -- ln -sF ~/Developer/fcomrqz/dotfiles/skhd/.skhdrc ~/
gum spin --title "skhd: Simple hotkey-daemon for macOS" -- skhd --start-service
