...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  // BASE
	[0] = LAYOUT_all(
		...
		KC_GRV,  KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,         KC_N,  KC_M,         KC_COMM,      KC_DOT,       KC_SLSH,         KC_EQL, KC_NO,
	...
	[9] = LAYOUT_all(
		...
		CW_TOGG, KC_P1,   KC_P2, KC_P3,   KC_P4,   KC_P5,   KC_P6,   KC_P7,   KC_P8,   KC_P9,   KC_P0,   KC_MINUS, KC_NO,
